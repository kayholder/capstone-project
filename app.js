document.addEventListener("DOMContentLoaded", function () {
  ...
  const books = [
    ...
    },
    {
      ...
      author: "JK Rowling",
      cover: "books/hpbooks.jpg",
    },
    {
      title: "We Hunt the Flame",
      author: "Hafsah Faizal",
      cover: "books/hung.jpg",
    },
    {
      title: "Divine Rivals",
      author: "Rebecca Ross",
      cover: "books/divinerivals.jpg",
    },
  ...
  async function fetchQuote() {
    try {
      ...
      if (data.content && data.author) {
        ...
        document.getElementById("book").innerHTML = data.tags
          ? data.tags.join(", ")
          : "N/A";
      ...
      document.getElementById("quote").innerHTML = "Could not fetch quote.";
    }
  }
